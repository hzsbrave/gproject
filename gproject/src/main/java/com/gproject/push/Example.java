package com.gproject.push;


import com.gproject.push.messages.TxtMessage;
...
//		CodeSuccessReslut messageBroadcastResult = rongCloud.message.broadcast("mvonotice", messageBroadcastTxtMessage, "thisisapush", "{\"pushData\":\"hello\"}", "iOS");
