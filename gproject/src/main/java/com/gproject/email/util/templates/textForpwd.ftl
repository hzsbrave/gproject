...
<body>
	<p>
		<div>
			...
			<h2>Email Title:</h2>
			<h2>Dear member</h2>
			<i >Please enter the following code <span>${vercode}</span> to verify your account.</i>Then you can reset your password.
			After that you can sign in with Email and new password. In order to protect your account,please
			do not allow others access to your email.
			<p class="line"></p>
		</div>
		<h3>GlobalMarket Group.All rights reserved</h3>
