 ...
 */
package com.gproject.util.redis.utils;

import com.gproject.util.redis.serializer.JdkSerializer;
import com.gproject.util.redis.serializer.RedisSerializer;
...
public class SerializerUtils {
    ...
    // 序列化集合
    @SuppressWarnings({"unchecked"})
    public static <T extends Collection<?>> T deserializeValues(
            Collection<byte[]> rawValues, Class<T> type,
        ...
        Collection<Object> values = (List.class.isAssignableFrom(type) ? new ArrayList<Object>(
                rawValues.size()) : new LinkedHashSet<Object>(rawValues.size()));
